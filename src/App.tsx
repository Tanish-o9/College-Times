...
const ConnectionsPage = lazy(() => import('./features/profile/ConnectionsPage').then(m => ({ default: m.ConnectionsPage })));
const CampusHome = lazy(() => import('./features/home/CampusHome').then(m => ({ default: m.CampusHome })));
...
const MyApplications = lazy(() => import('./features/opportunities/MyApplications').then(m => ({ default: m.MyApplications })));
